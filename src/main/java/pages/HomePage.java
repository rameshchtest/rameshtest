...
public class HomePage extends BirlaVisionWrappers{
	...
	{
		clickMenu(prop.getProperty("HomePage.MainmenuReport.ID"),prop.getProperty("HomePage.SubmenuDTSMRpt.ID"),prop.getProperty("HomePage.MainmenuTansactions.MenuOptionEODMarking.ID"));
